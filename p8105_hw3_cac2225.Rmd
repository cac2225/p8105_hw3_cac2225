...
Filter the data set by year (2002, 2006 and 2010), response (Excellent) and locationabbr (NY). Calculate the mean and standard deviation of the proportion of Excellent responses across NY state.
