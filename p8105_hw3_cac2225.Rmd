...
instacart %>% 
  ...
  group_by(aisle) %>% 
  summarise(sum(order_count))
```


Using the n_distinct and count functions, there are 134 distinct aisle_ids, thus there are 134 aisles. Using the group_by and summarize functions, for each aisle, 