...
The mean value of the proportion of each response was generated using group by and summarize functions, grouped by year and response type. Five different plots were generated based on this dataset, seperated by response type. Using facet, a five panel plot per response type was created, each panel contained a violin plot of proportion of responses over the years. Thus over the years, for excellent responses, the proportion of response were mainly around 20. The max proportion was 30 and min proportion was 10 in 2006.
